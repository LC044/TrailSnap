...
type Tab = 'public' | 'dashboard' | 'submit' | 'mine' | 'admin' | 'versions' | 'integrations' | 'ai-settings' | 'users'
...
onMounted(async () => {
  ...
  if (requestedTab && ['public', 'dashboard', 'submit', 'mine', 'admin', 'versions', 'integrations', 'ai-settings', 'users'].includes(requestedTab)) tab.value = requestedTab
